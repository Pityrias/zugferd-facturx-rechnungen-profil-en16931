...
Da LibreOffice Erweiterungen (auch Makros genannt) aus unbekannten Quellen ein Sicherheitsrisiko darstellen können, sind die meisten Makros in der Standardeinstellung von LibreOffice deaktiviert. Damit diese Erweiterung funktionieren kann, muss diese Einstellung angepasst werden.
...
Dieses Kapitel erklärt was beim Erstellen Ihrer eigenen Rechnungen zu beachten ist und wie sie kleinere Anpassungen vornehmen können.
...
- Spalte B Code: Der offizielle Coder der Steuerkategorie, aus der [UNTDID 5305](https://unece.org/fileadmin/DAM/trade/untdid/d16b/tred/tred5305.htm). Unterstützte Kategorien können Sie Tab 3 `Codes` entnehmen
- Spalte C Steuersatz: Bitte Wert ohne Einheiten- und Leerzeichen eintragen
- Spalte D Summe MwSt: Bitte Wert ohne Einheiten- und Leerzeichen eintragen
- Spalte E Betrag der nach Kategorie besteuert wird: Bitte Wert ohne Einheiten- und Leerzeichen eintragen
...
**Hinweis: Dieses Kapitel setzt Kenntnisse über die Verwendung von Formeln in LibreOffice Writer voraus.**

### Wichtige Hinweise

Das finale Aussehen der Rechnung ergibt sich aus der Rechnungsansicht in Tab 1 der Vorlage. Alle kosmetischen Änderungen sollten in dieser Ansicht gemacht werden. Die Datenansicht in Tab 2 dient als Grundlage der eingebetteten xml Datei. Dabei erwartet die Erweiterung bestimmte Daten in bestimmten Zeilen. 
...
| Der Wert der Zelle X in Tab zwei ist Y; er muss ein Datum sein. | Das Feld aktzeptiert nur ein Datum. | Geben Sie ein Datum ein und prüfen Sie die Zellenformatierung. |
...
| Ländercodes müssen zwei Buchstaben haben. | Die Landesangabe entspricht nicht DIN ISO 3166. | Wählen Sie in der Rechnungsansicht das Land in der Dropdown-Box aus. Haben Sie diese gelöscht, können Sie den 2-Buchstabencode auch im Tab 3 `Codes` manuell nachschlagen und in Tab 2 eintragen. |
